...
class Profile(models.Model):
    ...
    family_name = models.CharField(max_length=10, verbose_name='Фамилия', default=None)
    first_name = models.CharField(max_length=10, verbose_name='Имя', default=None)
    middle_name = models.CharField(max_length=10, verbose_name='Отчество', default=None)
    ...
    def __str__(self):
        return "{family_name} {first_name} {value} ({display_value})".format(family_name=self.family_name, first_name=self.first_name, value=self.position, display_value=self.get_position_display())
